...
<title>STMIK Pranata Indonesia | Link and Match</title>
  ...
  <div class="main-content">
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-1.jpg"  alt=""  data-bgposition="center 10%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-2.jpg"  alt=""  data-bgposition="center 40%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-3.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
    ...
    <section id="blog">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase text-theme-colored title line-bottom line-height-1 mt-0">Tentang <span class="text-theme-color-2 font-weight-400">PI</span></h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-140px" data-wow-duration="1s" data-wow-delay="0.1s">
              ...
              <img class="img-fullwidth" src="<?php echo base_url(); ?>assets/depan/images/home/ttg-1.jpg" alt="">
              <div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-140px" data-wow-duration="1s" data-wow-delay="0.1s">
              
              <img class="img-fullwidth" src="<?php echo base_url(); ?>assets/depan/images/home/ttg-2.jpg" alt="">
              <div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-0 wow fadeInUp" data-margin-top="-140px" data-wow-duration="1s" data-wow-delay="0.1s">
              ...
              <img class="img-fullwidth" src="<?php echo base_url(); ?>assets/depan/images/home/ttg-3.jpg" alt="">
              <div>
              </div>
            </div>
          </div>
    ...
    <section id="events" class="divider parallax layer-overlay overlay-dark-8" data-stellar-background-ratio="0.5" data-bg-img="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-2.jpg">
      ...
      <div class="container pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <div class="owl-carousel-4col" data-dots="false">
                
                  <div class="service-block bg-white">
                    <div class="thumb"> <img alt="featured project" src="<?php echo base_url(); ?>assets/depan/images/home/ka-1.jpg" class="img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">D3</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Komputer Akuntansi</h4>
                     <center><a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#">Lihat Lebih Lanjut</a></center>
                    </div>
                  </div>
                
               
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="<?php echo base_url(); ?>assets/depan/images/home/mi-2.jpg" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">D3</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Manajemen Informatika</h4>
                      <center><a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#">Lihat Lebih Lanjut</a></center>
                   </div>
                  </div>
                  ...
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="<?php echo base_url(); ?>assets/depan/images/home/si-3.jpg" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">S1</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Sistem Informasi</h4>
                      <center><a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#">Lihat Lebih Lanjut</a></center>
                   </div>
                  </div>
                
                  <div class="service-block mb-md-30 bg-white">
                    <div class="thumb"> <img alt="featured project" src="<?php echo base_url(); ?>assets/depan/images/home/ti-4.jpg" class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">S1</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Teknik Informatika</h4>
                      <center><a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#">Lihat Lebih Lanjut</a></center>
                    </div>
                  </div>
              ...
              <div id="grid" class="gallery-isotope grid-4 gutter clearfix">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/1.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/1.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select1">
                  <div class="thumb">
                    ...
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/2.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select2">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/3.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                ...
                <div class="gallery-item select3">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/4.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/4.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select1">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/5.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/5.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select3">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/6.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/6.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select2">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/7.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/7.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select3">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/8.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/8.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select1">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/9.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/9.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select2">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/10.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/10.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select1">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/11.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/11.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
                ...
                <div class="gallery-item select3">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/12.jpg"><i class="fa fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <a class="hover-link" data-lightbox="image" href="<?php echo base_url(); ?>assets/depan/images/gallery/12.jpg">View more</a>
                  </div>
                </div>
                <!-- Portfolio Item End -->
    ...
    <section class="divider parallax layer-overlay overlay-theme-colored-9" data-bg-img="<?php echo base_url(); ?>assets/depan/images/home/slider/slider-1.jpg" data-parallax-ratio="0.7">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
    ...
    <section id="blog">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase text-theme-colored title line-bottom line-height-1 mt-0">Berita <span class="text-theme-color-2 font-weight-400">Terbaru</span></h2>
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="<?php echo base_url(); ?>assets/depan/images/blog/4.jpg" alt="" class="img-responsive img-fullwidth"> </div>
                    <div class="entry-meta meta-absolute text-center pl-15 pr-15">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <ul>
      ...
      <div class="container pt-10 pb-20">
        <div class="row">
          <div class="call-to-action">
            <div class="col-md-10">
              <h3 class="mt-5 mb-5 text-white vertical-align-middle"><i class="pe-7s-users mr-10 font-48 vertical-align-middle"></i> INFORMASI PENERIMAAN MAHASISWA BARU </h3>
            </div>
            <div class="col-md-2">
