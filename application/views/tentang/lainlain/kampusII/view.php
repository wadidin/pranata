...
<!-- Page Title -->
<title>Kampus II Pengasinan | STMIK Pranata Indonesia</title>
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-sm-8 xs-text-center">
              <h2 class="text-white mt-10">Kampus II Pengasinan</h2>
            </div>
            <div class="col-sm-4">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="contact-info text-center">
                ...
                <h4>Alamat</h4>
                <h6 class="text-gray">Jl. Pengasinan Tengah Raya No. 28, Pengasinan, Rawalumbu.<br>Kota Bekasi, Jawa Barat, 17115.</h6>
              </div>
            </div>
            <div class="col-sm-12 col-md-4">
              <div class="contact-info text-center">
